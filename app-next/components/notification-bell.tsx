  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute -top-1 -right-1 bg-red text-[#ffffff] text-[10px] font-bold w-4 h-4 flex items-center justify-center rounded-full">
      ...
      {open && (
        <div className="fixed left-3 right-3 bottom-20 md:left-3 md:right-auto md:bottom-24 md:w-80 bg-dark-secondary rounded-xl border border-white/10 shadow-2xl z-[100] overflow-hidden toast-enter">
