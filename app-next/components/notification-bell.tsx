...
export default function NotificationBell() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {open && (
        <div className="fixed left-3 right-3 bottom-20 md:absolute md:left-0 md:bottom-full md:right-auto md:w-80 mb-2 bg-dark-secondary rounded-xl border border-white/10 shadow-2xl z-50 overflow-hidden toast-enter">
